...
async function handleWalletSearch(
  ...
  // Only show Zora profile if no tokens were found AND it meets our criteria
  if (zoraSummaryFromAddress && isSummaryAssociatedWithAddress(zoraSummaryFromAddress, address)) {
