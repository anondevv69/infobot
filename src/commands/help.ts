...
const HELP_MESSAGE = [
  ...
  "• `/w <address>` — Search wallet across all EVM chains (Ethereum, Base, Monad) or Solana",
  ...
  "• `/far <query>` — Search Farcaster users (username with or without @, or wallet)",
  "• `/f <query>` — Alias for `/far`",
