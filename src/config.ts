...
export const env = {
  ...
  miniappUrl: process.env.MINIAPP_URL || "https://farcaster.xyz/miniapps/019a995b-a271-dd1b-1b96-b4b601ca5972/infobot", // Mini App URL for Farcaster authentication
